...
class Converter(object):
  ...
  def __init__(self):
    ...
    self.bumper = 0
    self.charger = 0
    self.pub = rospy.Publisher('/autodocking',String)
  ...
  def DockIRCallback(self,data):
    ...
    ostr = ""
    send_string = ""
    send_string += "1" if self.charger else "0"
    send_string += "1" if self.bumper&4 else "0"
    send_string += "1" if self.bumper&2 else "0"
    send_string += "1" if self.bumper&1 else "0"
